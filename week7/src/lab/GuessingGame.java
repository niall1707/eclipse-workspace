...
public class GuessingGame extends JFrame {
   ...
   public GuessingGame() {
       ...
       checkGuessButton = new JButton("Check Guess"); // New button for checking guess

       checkGuessButton.addActionListener(new ActionListener() {
       ...
       panel.add(checkGuessButton); // Adding the check guess button
